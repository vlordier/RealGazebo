...
public:
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "RealGazebo|Performance|Limits", meta = (DisplayName = "Max Active Vehicles", DisplayPriority = "1", ClampMin = "1", ClampMax = "255"))
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "RealGazebo|Performance|Pool Management", meta = (DisplayName = "Max Actors Per Type", DisplayPriority = "1", ClampMin = "10", ClampMax = "255"))
