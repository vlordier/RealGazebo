...
#include "RealGazeboBridgeManager.generated.h"

// Forward declarations
class UGazeboBridgeSubsystem;

/**
 * User-friendly RealGazebo Bridge Manager Actor for plug-and-play usage
 *
 ...
 */
UCLASS(BlueprintType, Blueprintable, meta = (DisplayName = "RealGazebo Bridge Manager"))
class REALGAZEBOBRIDGE_API ARealGazeboBridgeManager : public AActor
{
    GENERATED_BODY()

public:
    ARealGazeboBridgeManager();
     ...
     */
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "RealGazebo|Performance|Limits",
     ...
     */
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "RealGazebo|Performance|Pool Management",
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "RealGazebo|Performance|Pool Management", meta = (DisplayName = "Initial Pool Size", DisplayPriority = "2", ClampMin = "5", ClampMax = "256"))
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "RealGazebo|Performance|Pool Management", meta = (DisplayName = "Pool Expansion Size", DisplayPriority = "4", ClampMin = "1", ClampMax = "100", EditCondition = "bAutoExpandPools"))
